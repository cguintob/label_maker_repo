...
def write_id(f, label_list, i):
    ...
    f.write('   <drawobj year="0" maskcharacter="" h="{0}" currentdata="" interval="1" day="0" level="Q" addtype="0" l="{1}" itemtype="8" zvalue="1" timeformat="0" barcodetype="QR_CODE" hour="0" rotate="270" memory="0" second="0" maskcontent="" symbolversion="0" encodemode="ANSI" datasource="0" dateformat="0" ucc="false" hidelanding="false" minute="0" month="0" repeat="1" lock="false" characterset="0" addorsub="0" density="0.62560" addbarcode="false" w="{2}" t="{3}">\n'.format(qr_height, ql, qr_width, qt))
    f.write('    <textlist>\n')
    ...
    f.write('    </textlist>\n')
    f.write('   </drawobj>\n')
    f.write('   <drawobj year="0" fontunderline="false" h="{0}" currentdata="1" interval="1" day="0" fontitalic="false" fontsize="{1}" hormirror="false" l="{2}" itemtype="5" zvalue="9" timeformat="0" linespacing="0" hour="0" rotate="270" memory="0" second="0" datasource="0" fontbold="false" fontfamily="Arial" startposition="0" stretch="87" dateformat="3" ellipse="false" minute="0" month="0" repeat="1" lock="false" addorsub="0" fontstrikeout="false" w="{3}" textlength="0" alignment="{4}" fontletterspacing="0" t="{5}" blackground="false">\n'.format(text_height, text_size, tl, text_width, text_alignment, tt))
    f.write('    <textlist>\n')
